...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    chats = Provider.of<DataProvider>(context).chats;
    chatClients = Provider.of<DataProvider>(context).chatClients;
    print(chatClients);
    return SafeArea(
                          ...
                          ? Padding(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  final id = client!.id == chats[index].receiverId
                                      ? chats[index].senderId
                                      : chats[index].receiverId;
                                  final cl = chatClients
